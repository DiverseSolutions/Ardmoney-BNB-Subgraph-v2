...
export class Token extends Entity {
  ...
  set mnt(value: BigDecimal) {
    this.set("mnt", Value.fromBigDecimal(value));
  }

  get tradeVolumeMNT(): BigDecimal {
    let value = this.get("tradeVolumeMNT");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set tradeVolumeMNT(value: BigDecimal) {
    this.set("tradeVolumeMNT", Value.fromBigDecimal(value));
  }
}
...
export class Pair extends Entity {
  ...
  get reserveMNT(): BigDecimal | null {
    let value = this.get("reserveMNT");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigDecimal();
  ...
  set reserveMNT(value: BigDecimal | null) {
    if (!value) {
      this.unset("reserveMNT");
    } else {
      this.set("reserveMNT", Value.fromBigDecimal(<BigDecimal>value));
    }
  }

  get volumeMNT(): BigDecimal | null {
    let value = this.get("volumeMNT");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigDecimal();
  ...
  set volumeMNT(value: BigDecimal | null) {
    if (!value) {
      this.unset("volumeMNT");
    } else {
      this.set("volumeMNT", Value.fromBigDecimal(<BigDecimal>value));
    }
  }
}
...
export class Mint extends Entity {
  ...
  get amountMNT(): BigDecimal | null {
    let value = this.get("amountMNT");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigDecimal();
  ...
  set amountMNT(value: BigDecimal | null) {
    if (!value) {
      this.unset("amountMNT");
    } else {
      this.set("amountMNT", Value.fromBigDecimal(<BigDecimal>value));
    }
  }
}
...
export class Swap extends Entity {
  ...
  set amountMNT(value: BigDecimal) {
    this.set("amountMNT", Value.fromBigDecimal(value));
  }
}
...
export class TokenDayData extends Entity {
  ...
  get priceMNT(): BigDecimal {
    let value = this.get("priceMNT");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set priceMNT(value: BigDecimal) {
    this.set("priceMNT", Value.fromBigDecimal(value));
  }

  get dailyVolumeMNT(): BigDecimal {
    let value = this.get("dailyVolumeMNT");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set dailyVolumeMNT(value: BigDecimal) {
    this.set("dailyVolumeMNT", Value.fromBigDecimal(value));
  }

  get totalLiquidityMNT(): BigDecimal {
    let value = this.get("totalLiquidityMNT");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set totalLiquidityMNT(value: BigDecimal) {
    this.set("totalLiquidityMNT", Value.fromBigDecimal(value));
  }
}
