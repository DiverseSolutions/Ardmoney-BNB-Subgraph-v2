...
export class Pair extends ethereum.SmartContract {
  ...
  balanceKeys(param0: BigInt): Address {
    let result = super.call("balanceKeys", "balanceKeys(uint256):(address)", [
  ...
  try_balanceKeys(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "balanceKeys",
      "balanceKeys(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  dynamicFee(): Address {
    let result = super.call("dynamicFee", "dynamicFee():(address)", []);

    return result[0].toAddress();
  }

  try_dynamicFee(): ethereum.CallResult<Address> {
    let result = super.tryCall("dynamicFee", "dynamicFee():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getPoolHasBalanceAddresses(): Array<Address> {
    let result = super.call(
      "getPoolHasBalanceAddresses",
      "getPoolHasBalanceAddresses():(address[])",
      [],
    );
  ...
  try_getPoolHasBalanceAddresses(): ethereum.CallResult<Array<Address>> {
    let result = super.tryCall(
      "getPoolHasBalanceAddresses",
      "getPoolHasBalanceAddresses():(address[])",
      [],
  ...
  hasUser(param0: Address): boolean {
    let result = super.call("hasUser", "hasUser(address):(bool)", [
      ethereum.Value.fromAddress(param0),
    ]);
  ...
  try_hasUser(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("hasUser", "hasUser(address):(bool)", [
      ethereum.Value.fromAddress(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
